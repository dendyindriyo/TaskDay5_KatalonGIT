...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/Field_Username'), 'John Doe')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/Field_Password'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Qwertyuiop')
